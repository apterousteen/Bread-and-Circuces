...
public class ManagerCard : MonoBehaviour
{
    public void Awake()
    {
        ...
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Оглушение щитом", "Sprites/LogoCards/ОглушениеЩитом", 1, Stance.Defensive, Stance.Attacking, Card.CardType.Attack, Card.CardEffect.Damage, 0, Card.CardEffect.Stun, 2, Card.TargetType.Enemy, "Смените стойку цели на атакующую. Противник должен сбросить две карты", CardRestriction.Murmillo));
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Оглушение щитом", "Sprites/LogoCards/ОглушениеЩитом", 1, Stance.Defensive, Stance.Attacking, Card.CardType.Attack, Card.CardEffect.Damage, 0, Card.CardEffect.Stun, 2, Card.TargetType.Enemy, "Смените стойку цели на атакующую. Противник должен сбросить две карты", CardRestriction.Murmillo));
        ...
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Заверщающий рубец", "Sprites/LogoCards/ЗавершающийРубец", 1, Stance.Attacking, Stance.Advance, Card.CardType.Attack, Card.CardEffect.DamageFinisher, 2, Card.CardEffect.No, 0, Card.TargetType.Enemy, "+1 к урону за каждую карту, разыгранную в эту активацию"));
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Заверщающий рубец", "Sprites/LogoCards/ЗавершающийРубец", 1, Stance.Attacking, Stance.Advance, Card.CardType.Attack, Card.CardEffect.DamageFinisher, 2, Card.CardEffect.No, 0, Card.TargetType.Enemy, "+1 к урону за каждую карту, разыгранную в эту активацию"));
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Отталкивание", "Sprites/LogoCards/Отталкивание", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.PushBackEnemy, 1, Card.CardEffect.CardDrow, 2, Card.TargetType.Enemy, "Передвиньте врага на 1 гекс. Возьмите 2 карты", CardRestriction.Murmillo));
        CardManager.AllCards.Add(new Card(CardRestriction.Murmillo, "Отталкивание", "Sprites/LogoCards/Отталкивание", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.PushBackEnemy, 1, Card.CardEffect.CardDrow, 2, Card.TargetType.Enemy, "Передвиньте врага на 1 гекс. Возьмите 2 карты", CardRestriction.Murmillo));
