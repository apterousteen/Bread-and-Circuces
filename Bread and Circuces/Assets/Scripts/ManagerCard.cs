...
public class ManagerCard : MonoBehaviour
{
    public void Awake()
    {
        ...
        CardManager.AllCards.Add(new Card(CardRestriction.Retiarius, "Контратака", "Sprites/LogoCards/Контратака", 1, Stance.Defensive, Stance.Attacking, Card.CardType.Attack, Card.CardEffect.Damage, 3, Card.CardEffect.CardDrow, 1, Card.TargetType.Enemy, "Возьмите карту"));
        CardManager.AllCards.Add(new Card(CardRestriction.Retiarius, "Тычок с отскоком", "Sprites/LogoCards/ТычокСОтскоком", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.Damage, 2, Card.CardEffect.Movement, 1, Card.TargetType.Enemy));
        CardManager.AllCards.Add(new Card(CardRestriction.Retiarius, "Тычок с отскоком", "Sprites/LogoCards/ТычокСОтскоком", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.Damage, 2, Card.CardEffect.Movement, 1, Card.TargetType.Enemy));
        ...
        CardManager.AllCards.Add(new Card(CardRestriction.Scissor, "Яростный рывок", "Sprites/LogoCards/ЯростныйРывок", 1, Stance.Advance, Stance.Raging, Card.CardType.Attack, Card.CardEffect.ChargeStart, 4, Card.CardEffect.ChargeEnd, 4, Card.TargetType.Enemy, "Перед атакой передвиньте этого бойца на расстояние до 4 гексов. Снизьте урон на 1 за каждый пройденный гекс", CardRestriction.Scissor));//нужен метод
        CardManager.AllCards.Add(new Card(CardRestriction.Scissor, "Яростный рывок", "Sprites/LogoCards/ЯростныйРывок", 1, Stance.Advance, Stance.Raging, Card.CardType.Attack, Card.CardEffect.ChargeStart, 4, Card.CardEffect.ChargeEnd, 4, Card.TargetType.Enemy, "Перед атакой передвиньте этого бойца на расстояние до 4 гексов. Снизьте урон на 1 за каждый пройденный гекс", CardRestriction.Scissor));//нужен метод
        CardManager.AllCards.Add(new Card(CardRestriction.Scissor, "Яростный рывок", "Sprites/LogoCards/ЯростныйРывок", 1, Stance.Advance, Stance.Raging, Card.CardType.Attack, Card.CardEffect.ChargeStart, 4 ,Card.CardEffect.ChargeEnd, 4, Card.TargetType.Enemy, "Перед атакой передвиньте этого бойца на расстояние до 4 гексов. Снизьте урон на 1 за каждый пройденный гекс", CardRestriction.Scissor));//нужен метод
        ...
        CardManager.AllCards.Add(new Card(CardRestriction.Hoplomachus, "Прикрыться", "Sprites/LogoCards/Прикрыться", 0, Stance.Advance, Stance.Defensive, Card.CardType.Defense, Card.CardEffect.ShieldedDefense, 1, Card.CardEffect.CardDrow, 1, Card.TargetType.This, "+1 к защите, если этот боец Щитовик. Возьмите карту"));
        CardManager.AllCards.Add(new Card(CardRestriction.Hoplomachus, "Тычок с отскоком", "Sprites/LogoCards/ТычокСОтскоком", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.Damage, 2, Card.CardEffect.Movement, 1, Card.TargetType.Enemy));
        CardManager.AllCards.Add(new Card(CardRestriction.Hoplomachus, "Тычок с отскоком", "Sprites/LogoCards/ТычокСОтскоком", 1, Stance.Attacking, Stance.Defensive, Card.CardType.Attack, Card.CardEffect.Damage, 2, Card.CardEffect.Movement, 1, Card.TargetType.Enemy));
